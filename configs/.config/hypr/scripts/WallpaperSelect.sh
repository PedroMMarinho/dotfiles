...
# WALLPAPERS PATH
wallDIR="$HOME/.config/hypr/images/wallpapers"
...
# Variables
rofi_theme="$HOME/.config/rofi/configs/config-wallpaper.rasi"
...
menu() {
    ...
    for pic_path in "${sorted_options[@]}"; do
        ...
        parent_dir=$(basename "$(dirname "$pic_path")")
        name_no_ext="${pic_name%.*}"
        
        display_name="$parent_dir/$name_no_ext"
...
modify_startup_config() {
  ...
  local startup_config="$HOME/.config/hypr/configs/autostart.conf"
